...
```bash
# Generate migration otomatis (sertakan path + nama file lengkap)
...
npm run migration:generate -- src/migration/NamaMigration  # Generate migration dari entity
npm run migration:create -- src/migration/NamaMigration    # Buat migration manual
